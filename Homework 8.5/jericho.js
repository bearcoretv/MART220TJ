...
function preload() {
  ...
  leafSprite = createSprite(400, 400);
  leafSprite.addAnimation('fading', './assets/images/leaf1.png', './assets/images/leaf7.png');
  leafSprite.addAnimation('static', './assets/images/leaf1.png');
}
...
function draw() {
  leafSprite.debug = mouseIsPressed;

  //if no arrow input set velocity to 0
  //leafSprite.velocity.x = (mouseX - leafSprite.position.x) / 10;
  //leafSprite.velocity.y = (mouseY - leafSprite.position.y) / 10;
